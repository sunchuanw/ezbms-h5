...
MetronicApp.factory('settings', ['$rootScope', function($rootScope) {
    ...
    var settings = {
        layout: {
            pageSidebarClosed: false, // sidebar state 侧边栏状态
            pageAutoScrollOnLoad: 1000 // auto scroll to top on page load自动滚动到页面加载的顶部
        },
...
MetronicApp.controller('PageHeadController', ['$scope', function($scope) {
    $scope.$on('$includeContentLoaded', function() {         // 可以通过$on()方法来注册事件监听事件。
...
MetronicApp.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state('dashboard', {
            ...
            // key  – {string}：注入控制器的依赖项名称。value - {string|function}：
            resolve: {
